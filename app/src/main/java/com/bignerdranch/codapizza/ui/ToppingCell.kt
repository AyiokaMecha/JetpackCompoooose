...
fun ToppingCell(
    ...
    Log.d("ToppingCell", "Called topping cell $topping")
    Row(
        ...
        Column(
            ...
            Text(text = stringResource(topping.toppingName), style = MaterialTheme.typography.body1)
            if(placement != null) {
                Text(text = stringResource(placement.label), style = MaterialTheme.typography.body2)
            }
